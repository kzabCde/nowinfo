const feed=(id,name,publisher,category,region,url,site,market='global',language='en',extra={})=>({id,name,publisher,category,region,url,site,market,language,...extra});
...
const thai=(id,name,publisher,category,url,site,language='th',extra={})=>feed(id,name,publisher,category,'asia',url,site,'thailand',language,extra);
const thaiGoogleNews=(id,name,publisher,query,site)=>thai(
 id,name,publisher,'world',
 `https://news.google.com/rss/search?q=${encodeURIComponent(query)}&hl=th&gl=TH&ceid=TH:th`,
 site,'th',{via:'google-news'}
);
...
export const sources=[
 ...
 // These publishers do not expose a consistently verifiable public RSS endpoint for NowInfo.
 // Use Google News RSS constrained to each publisher's official domain so failures stay isolated
 // and articles still retain Thailand-market metadata without scraping article bodies.
 thaiGoogleNews('thaipbs','Thai PBS · Latest','Thai PBS','site:thaipbs.or.th/news','https://www.thaipbs.or.th/news'),
 thaiGoogleNews('pptv','PPTV HD36 · Latest','PPTV HD36','site:pptvhd36.com/news','https://www.pptvhd36.com/news'),
 thaiGoogleNews('tnn','TNN · Latest','TNN','site:tnnthailand.com','https://www.tnnthailand.com'),
 thaiGoogleNews('workpointtoday','workpoint TODAY · Latest','workpoint TODAY','site:workpointtoday.com','https://www.workpointtoday.com'),
 thaiGoogleNews('bangkokbiznews','กรุงเทพธุรกิจ · Latest','กรุงเทพธุรกิจ','site:bangkokbiznews.com','https://www.bangkokbiznews.com')
];
